...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "card.threshold_title": "⚠️ Usage warning",
        "card.reminder_title": "🔔 Quota reset soon",
        "card.status_title": "ℹ️ Connection notice",
        "card.test_title": "✅ Connection test",
        "card.usage_title": "📊 Current usage",
        "card.test_body": "Webhook notifications are working.",
    ...
    "ko": {
        ...
        "card.threshold_title": "⚠️ 사용량 경고",
        "card.reminder_title": "🔔 리셋 예고",
        "card.status_title": "ℹ️ 연결 상태 안내",
        "card.test_title": "✅ 연결 테스트",
        "card.usage_title": "📊 현재 사용량",
        "card.test_body": "웹훅 알림이 정상적으로 연결됐어요.",
        "notify.info_title": "tokentray",
