...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "discord.threshold_title": "⚠️ Usage warning",
        "discord.reminder_title": "🔔 Quota reset soon",
        "discord.status_title": "ℹ️ Connection notice",
        "discord.test_title": "✅ Connection test",
        "discord.usage_title": "📊 Current usage",
        "discord.test_body": "Webhook notifications are working.",
        ...
        "integration.usage": "Send usage",
        "integration.usage_fetching": "Fetching usage…",
        "integration.usage_sending": "Sending usage cards…",
        "integration.usage_ok": "Sent {n} usage cards.",
        "integration.usage_failed": "Sent {n} cards, then failed: {reason}",
        "integration.usage_empty": "No enabled providers to preview.",
        "integration.save": "Save",
        "integration.cancel": "Cancel",
        "integration.help": "Setup instructions",
    ...
    "ko": {
        ...
        "discord.threshold_title": "⚠️ 사용량 경고",
        "discord.reminder_title": "🔔 리셋 예고",
        "discord.status_title": "ℹ️ 연결 상태 안내",
        "discord.test_title": "✅ 연결 테스트",
        "discord.usage_title": "📊 현재 사용량",
        "discord.test_body": "웹훅 알림이 정상적으로 연결됐어요.",
        "notify.info_title": "tokentray",
        ...
        "integration.test": "연결 테스트",
        "integration.usage": "사용량 보내기",
        "integration.usage_fetching": "사용량 조회 중…",
        "integration.usage_sending": "사용량 카드 전송 중…",
        "integration.usage_ok": "사용량 카드 {n}개 전송 완료.",
        "integration.usage_failed": "{n}개 전송 후 실패: {reason}",
        "integration.usage_empty": "사용량을 조회할 활성화된 서비스가 없습니다.",
        "integration.save": "저장",
        "integration.cancel": "취소",
        "integration.help": "설정 방법",
